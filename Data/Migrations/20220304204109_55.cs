    ...
    public partial class _55 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryToPosts", x => new { x.CategoryId, x.PostId });
                    table.ForeignKey(
                        name: "FK_CategoryToPosts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryToPosts_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryToPosts_PostId",
